...
void createLocalB(Matrix &B,mesh m){
    ...
    float ka= m.getParameter(KA);
    B.at(0).at(0) += ka/l;    B.at(0).at(1) += -ka/l;
    B.at(1).at(0) += -ka/l;    B.at(1).at(1) += ka/l;
}


void createLocalC(Matrix &C,mesh m){
    float alpha = m.getParameter(ALPHA);
    C.at(0).at(0) += (-3*alpha)/2;     C.at(0).at(1) += (3*alpha)/2;
    C.at(1).at(0) += (-3*alpha)/2;     C.at(1).at(1) += (3*alpha)/2;
}
...
void createLocalE(Matrix &E,mesh m){
    ...
    E.at(0).at(0) += -lambda/3;  E.at(0).at(1) += lambda/3;
    E.at(1).at(0) += -lambda/3;  E.at(1).at(1) += lambda/3;
}
...
Matrix createLocalK(int element,mesh &m){
    ...
    row1.push_back(E.at(0).at(0)+D.at(0).at(0));                  
    row1.push_back(E.at(0).at(1)+D.at(0).at(1));

    row2.push_back(A.at(1).at(0)+B.at(1).at(0)); 
    row2.push_back(A.at(1).at(1)+B.at(1).at(1));
    row2.push_back(E.at(1).at(0)+D.at(1).at(0));                  
    row2.push_back(E.at(1).at(1)+D.at(1).at(1));
