...
enum parameters {ELEMENT_LENGTH,TAU,KA,LAMBDA,V,PSI,ALPHA,DELTA,ETA};
...
class mesh{
    ...
    public:
        void setParameters(float l, float tau,float ka, float lambda,float v,float psi,float alpha,float delta,float eta){
